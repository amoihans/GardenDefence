...
const PLANTS: Dictionary = {
    ...
    "torchwood": {
        ...
        "max_hp": 100,
        "cooldown": 30.0,
        "description": "被动增益：豌豆穿过变火球（伤害 ×2），且能命中飞行单位（气球）。",
        "scene_path": "res://scenes/plants/Torchwood.tscn",
        "icon_path": "res://assets/plants/torchwood.svg",
    },
    "fume_shroom": {
        "display_name": "忧郁菇",
        "cost": 75,
        "max_hp": 60,
        "cooldown": 7.5,
        "description": "范围攻击：每 1.5 秒对 220 像素内的所有僵尸喷 20 伤害（不分行，可打气球）。",
        "scene_path": "res://scenes/plants/FumeShroom.tscn",
        "icon_path": "res://assets/plants/fume_shroom.svg",
    },
    "magnet_shroom": {
        "display_name": "磁力菇",
        "cost": 100,
        "max_hp": 60,
        "cooldown": 7.5,
        "description": "每 8 秒吸走同行最近一个护盾僵尸的护盾（当前只对读报僵尸有效）。",
...
const ZOMBIES: Dictionary = {
    ...
    "balloon": {
        ...
        "speed": 18.0,
        "damage_per_sec": 25.0,
        "description": "气球吊着飞过草坪。**普通豌豆打不到**。需用火炬（豌豆变火球）或忧郁菇（范围）。",
        "scene_path": "res://scenes/zombies/BalloonZombie.tscn",
        "icon_path": "res://assets/zombies/balloon_zombie.svg",
    },
    "gargantuar": {
        "display_name": "巨人僵尸",
        "max_hp": 3000,
        "speed": 6.0,
        "damage_per_sec": 60.0,
        "description": "Boss 级肉盾：3000 HP + 60 DPS。速度慢但几乎不可能快速击破，需要持续火力。",
        "scene_path": "res://scenes/zombies/GargantuarZombie.tscn",
        "icon_path": "res://assets/zombies/gargantuar_zombie.svg",
    },
    "miner": {
        "display_name": "矿工僵尸",
        "max_hp": 200,
        "speed": 20.0,
        "damage_per_sec": 30.0,
        "description": "从 col=4 中段地下钻出，绕过前置射手直冲后排。出土时附带 8 颗土粒粒子。",
        "scene_path": "res://scenes/zombies/MinerZombie.tscn",
        "icon_path": "res://assets/zombies/miner_zombie.svg",
    },
}
...
const LEVELS: Array = [
    ...
    # ---------- day4 ~ day8：新植物 / 气球 / 巨人 / 矿工 ----------
    {
        "id": "day4",
        "name": "白天 - 第4天",
        "description": "首遇气球 + 巨人。需火炬让豌豆变火球，或忧郁菇范围攻击。",
        "unlock": true,
        "environment": "day",
        "no_sky_sun": false,
        "start_sun": 75,
        "sky_tint": Color(0.40, 0.60, 0.85, 1),
        "waves": [
            {"spawns": ["balloon", "basic", "basic"], "interval": 5.0, "rest": 9.0},
            {"spawns": ["basic", "conehead", "balloon", "basic", "conehead"], "interval": 4.5, "rest": 9.0},
            {"spawns": ["balloon", "buckethead", "basic", "conehead", "balloon", "basic"],
             "interval": 4.0, "rest": 9.0},
            {"spawns": ["gargantuar", "balloon", "basic", "conehead", "balloon"],
             "interval": 3.5, "rest": 9.0},
            {"spawns": ["gargantuar", "balloon", "basic", "balloon", "conehead", "balloon", "basic"],
             "interval": 3.0, "rest": 0.0},
        ],
    },
    {
        "id": "day5",
        "name": "白天 - 第5天",
        "description": "气球多 + 巨人固定出场。需忧郁菇 + 火炬 + 坚果墙组合。",
        "unlock": true,
        "environment": "day",
        "no_sky_sun": false,
        "start_sun": 75,
        "sky_tint": Color(0.40, 0.60, 0.85, 1),
        "waves": [
            {"spawns": ["balloon", "basic", "balloon", "conehead"], "interval": 4.5, "rest": 8.0},
            {"spawns": ["balloon", "buckethead", "basic", "balloon", "conehead", "basic"],
             "interval": 4.0, "rest": 8.0},
            {"spawns": ["gargantuar", "balloon", "basic", "conehead", "balloon", "buckethead", "balloon"],
             "interval": 3.5, "rest": 8.0},
            {"spawns": ["gargantuar", "balloon", "newspaper", "balloon", "basic", "conehead", "balloon"],
             "interval": 3.0, "rest": 8.0},
            {"spawns": ["gargantuar", "balloon", "newspaper", "balloon", "basic", "balloon", "football", "balloon"],
             "interval": 2.8, "rest": 0.0},
        ],
    },
    {
        "id": "day6",
        "name": "白天 - 第6天",
        "description": "首遇矿工：中段突袭。需要在 col=4 周围提前布防，或拖到边缘被豌豆解决。",
        "unlock": true,
        "environment": "day",
        "no_sky_sun": false,
        "start_sun": 75,
        "sky_tint": Color(0.40, 0.60, 0.85, 1),
        "waves": [
            {"spawns": ["basic", "miner", "basic"], "interval": 5.0, "rest": 9.0},
            {"spawns": ["conehead", "basic", "miner", "basic", "conehead"], "interval": 4.5, "rest": 9.0},
            {"spawns": ["miner", "buckethead", "basic", "miner", "conehead", "basic"],
             "interval": 4.0, "rest": 9.0},
            {"spawns": ["miner", "balloon", "basic", "miner", "conehead", "buckethead"],
             "interval": 3.5, "rest": 9.0},
            {"spawns": ["miner", "balloon", "basic", "miner", "balloon", "conehead", "miner", "basic"],
             "interval": 3.0, "rest": 0.0},
        ],
    },
    {
        "id": "day7",
        "name": "白天 - 第7天",
        "description": "气球 + 矿工协同：天空与地下同时夹击。需火炬 / 忧郁菇 / 磁力菇全开。",
        "unlock": true,
        "environment": "day",
        "no_sky_sun": false,
        "start_sun": 100,
        "sky_tint": Color(0.40, 0.60, 0.85, 1),
        "waves": [
            {"spawns": ["balloon", "miner", "basic"], "interval": 4.5, "rest": 8.0},
            {"spawns": ["balloon", "basic", "miner", "conehead", "balloon", "basic"],
             "interval": 4.0, "rest": 8.0},
            {"spawns": ["balloon", "miner", "newspaper", "basic", "balloon", "miner", "conehead"],
             "interval": 3.5, "rest": 8.0},
            {"spawns": ["gargantuar", "balloon", "miner", "basic", "balloon", "miner", "conehead"],
             "interval": 3.2, "rest": 8.0},
            {"spawns": ["gargantuar", "balloon", "miner", "newspaper", "balloon", "miner", "football", "balloon"],
             "interval": 2.8, "rest": 0.0},
        ],
    },
    {
        "id": "day8",
        "name": "白天 - 第8天（终极日间）",
        "description": "气球 + 矿工 + 巨人 + 精英全上。三大新植物必须配合坚果墙、樱桃、辣椒同时使用。",
        "unlock": true,
        "environment": "day",
        "no_sky_sun": false,
        "start_sun": 125,
        "sky_tint": Color(0.40, 0.60, 0.85, 1),
        "waves": [
            {"spawns": ["gargantuar", "balloon", "miner", "basic"], "interval": 4.5, "rest": 7.0},
            {"spawns": ["gargantuar", "balloon", "miner", "newspaper", "conehead", "balloon"],
             "interval": 4.0, "rest": 7.0},
            {"spawns": ["gargantuar", "balloon", "miner", "football", "balloon", "miner", "newspaper"],
             "interval": 3.5, "rest": 7.0},
            {"spawns": ["gargantuar", "balloon", "miner", "football", "newspaper", "balloon", "miner", "buckethead"],
             "interval": 3.0, "rest": 7.0},
            {"spawns": ["gargantuar", "gargantuar", "balloon", "miner", "football", "newspaper",
                        "balloon", "miner", "basic", "balloon", "miner", "conehead"],
             "interval": 2.5, "rest": 0.0},
        ],
    },
]
